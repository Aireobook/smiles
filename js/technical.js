...
if (typeof create_technical !== "function"){
    ...
    function create_technical(self){
...
function tech_yt_image() {
    ...
    if (result.length > 5){
        ...
        tech_yt_preview(result);

        document.getElementById('c').value = image_name;
...
/**
     Buttony zawierające klasę x, data-function = y

     let x = new RightModal( 'x', ...

     x.content('button') - wszystko co zawiera button

        interesuje nas data-function.
